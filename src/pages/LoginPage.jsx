    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setLoading(false) // Reset loading only on failure; success redirects
                }
              }}
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed hover:from-blue-500 hover:to-purple-500 transform hover:scale-105 active:scale-95"
            >
              {loading ? (
          ...
          {/* Firebase warning */}
          {!firebaseReady && (
            <div className="mt-4 rounded-xl border border-amber-500/30 bg-amber-500/10 backdrop-blur-sm px-4 py-3 text-xs text-amber-200">
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4" />
                <span>
